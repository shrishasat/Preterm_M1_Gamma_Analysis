...
The included script (`extract_gamma_metrics.m`) loads each subject’s TF `.mat` file, identifies the 0–100 ms post-movement window, extracts peak gamma power and frequency from contralateral and ipsilateral M1 sensors
...
## Usage
1. load your subject's TF mat file
